...
<ol>
  ...
  <li>حالا برای حذف تایم‌کدها، از منوی بالا به مسیر <code>File > Save as</code> بروید. در پنجره باز شده، از لیست کشویی <code>Save as type</code>، فرمت <b>MicroDVD (*.sub)</b> را انتخاب و فایل را ذخیره کنید.</li>
...
<p><b>خروجی این مرحله:</b> یک فایل متنی ساده که فقط شامل دیالوگ‌هاست.</p>
<img src="02-subtitle-edit-sort.png" alt="مرتب‌سازی زیرنویس" width="600"/>
...
<ol>
  <li>با یک فیلترشکن مناسب، وارد سایت <b><a href="https://aistudio.google.com/">Google AI Studio</a></b> شوید.</li>
  <li>در پنل سمت چپ، حالت <code>Chat</code> را انتخاب کنید. سپس از پنل تنظیمات در سمت راست، مدل (<code>Model</code>) را روی <b>Gemini 2.5 Pro</b> تنظیم کنید.</li>
...
<img src="05-gemini-settings.png" alt="تنظیمات مدل Gemini" width="600"/>
...
<img src="11-translation-result.png" alt="نتیجه ترجمه" width="600"/>
...
<img src="13-save-final.png" alt="ذخیره نهایی" width="600"/>
...
```text
**[CODE]پرامت پیشرفته برای ترجمه حرفه‌ای زیرنویس انیمه (فرمت 'میکرو دی وی دی')**
